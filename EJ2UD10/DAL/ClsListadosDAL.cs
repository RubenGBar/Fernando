...
namespace DAL
{
    public class ClsListadosDAL
    {
        ...
        public static List<ClsPersona> obtenerListadoBD()
        {
            ...
            try
            {
                miConexion.ConnectionString = "server=localhost;database=RubenBD;uid=usuario;pwd=LaCampana123;trustServerCertificate=true;";
                miConexion.Open();
                ...
                if (miLector.HasRows)
                {
                    while (miLector.Read())
                    {
                        oPersona = new ClsPersona
                        {
                            ...
                            Dni = (int)miLector["Dni"],
                            Sexo = (string)miLector["Sexo"]
                        };
            ...
            {
                throw new Exception("Error al conectar con la base de datos", exSql);
            }
